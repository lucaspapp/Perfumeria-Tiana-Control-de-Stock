...
Aplicación para administrar productos, entradas, ventas, pérdidas, existencias e indicadores. Utiliza HTML5, Bootstrap 5 por CDN, JavaScript nativo, PHP con PDO y MySQL/MariaDB. No utiliza Node.js ni CSS propio.
